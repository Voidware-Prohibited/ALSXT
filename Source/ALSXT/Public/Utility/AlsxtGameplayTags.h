...
{
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(KillerCam)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(IsometricTopDown)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Cinematic)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(FourthPerson)
}
...
namespace AlsLocomotionModeTags
{
	...
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Climbing)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(SwimmingTreading)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(SwimmingUnderwater)
}
...
namespace AlsxtStatusEffectLocomotionVariantSeverityTags
{
	...
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Severe)
}
...
namespace AlsxtStatusEffectLocomotionVariantTags
{
	...
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Hot)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Exhaustion)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Illness)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InjuryHead)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InjuryAbdomen)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InjuryLeftArm)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InjuryRightArm)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InjuryLeftLeg)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InjuryRightLeg)
}

namespace AlsxtReadinessTags
{
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Relaxed)
