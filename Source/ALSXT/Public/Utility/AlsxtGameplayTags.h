...
{
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(SlopeSliding)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Stationary)
...
{
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Axe)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Knife)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(HandsTiedBothHands)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(DefaultBothHands)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(DefaultLeftHandActive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(DefaultLeftHandNeutral)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(DefaultLeftHandPassive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(DefaultRightHandActive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(DefaultRightHandNeutral)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(DefaultRightHandPassive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(RifleBothHands)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(RifleLeftHandActive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(RifleLeftHandNeutral)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(RifleLeftHandPassive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(RifleRightHandActive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(RifleRightHandNeutral)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(RifleRightHandPassive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(PistolBothHands)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(PistolLeftHandActive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(PistolLeftHandNeutral)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(PistolLeftHandPassive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(PistolRightHandActive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(PistolRightHandNeutral)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(PistolRightHandPassive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(BowBothHands)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TorchBothHands)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TorchLeftHandActive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TorchLeftHandNeutral)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TorchLeftHandPassive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TorchRightHandActive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TorchRightHandNeutral)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TorchRightHandPassive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(BinocularsBothHands)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(BinocularsLeftHandActive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(BinocularsLeftHandNeutral)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(BinocularsLeftHandPassive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(BinocularsRightHandActive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(BinocularsRightHandNeutral)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(BinocularsRightHandPassive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(BoxBothHands)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(BarrelBothHands)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(BarreLeftHandActive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(BarreLeftHandNeutral)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(BarreLeftHandPassive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(BarreRightHandActive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(BarreRightHandNeutral)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(BarreRightHandPassive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(AxeBothHands)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(AxeLeftHandActive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(AxeLeftHandNeutral)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(AxeLeftHandPassive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(AxeRightHandActive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(AxeRightHandNeutral)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(AxeRightHandPassive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(PickaxeBothHands)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(PickaxeLeftHandActive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(PickaxeLeftHandNeutral)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(PickaxeLeftHandPassive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(PickaxeRightHandActive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(PickaxeRightHandNeutral)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(PickaxeRightHandPassive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(KnifeLeftHandActive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(KnifeLeftHandNeutral)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(KnifeLeftHandPassive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(KnifeRightHandActive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(KnifeRightHandNeutral)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(KnifeRightHandPassive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(HammerLeftHandActive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(HammerLeftHandNeutral)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(HammerLeftHandPassive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(HammerRightHandActive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(HammerRightHandNeutral)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(HammerRightHandPassive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GrenadeLeftHandNeutral)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GrenadeLeftHandPassive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GrenadeRightHandNeutral)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GrenadeRightHandPassive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(BuildingPlanBothHands)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(BuildingPlanLeftHandActive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(BuildingPlanLeftHandNeutral)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(BuildingPlanLeftHandPassive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(BuildingPlanRightHandActive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(BuildingPlanRightHandNeutral)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(BuildingPlanRightHandPassive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(FlashlightBothHands)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(FlashlightLeftHandActive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(FlashlightLeftHandNeutral)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(FlashlightLeftHandPassive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(FlashlightRightHandActive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(FlashlightRightHandNeutral)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(FlashlightRightHandPassive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(KatanaBothHands)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(KatanaLeftHandActive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(KatanaLeftHandNeutral)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(KatanaLeftHandPassive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(KatanaRightHandActive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(KatanaRightHandNeutral)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(KatanaRightHandPassive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(SwordBothHands)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(SwordLeftHandActive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(SwordLeftHandNeutral)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(SwordLeftHandPassive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(SwordRightHandActive)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(SwordRightHandNeutral)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(SwordRightHandPassive)
}
...
{
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(SidlingRight)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(SidlingLeft)
}
...
{
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Orthodox)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Southpaw)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Neutral)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Ready)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Aiming)
}
...
namespace ALSXTWeaponReadyPositionTags
{
	...
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Wading)
...
namespace ALSXTHandTags
{
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Left)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Right)
	ALSXT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(BothHands)
}
