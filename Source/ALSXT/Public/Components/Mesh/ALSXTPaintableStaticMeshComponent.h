...
public:
	...
	UPROPERTY(BlueprintAssignable)
	FOnChangeStaticMeshPaintingSettingsMapSignature OnChangeMeshPaintingSettingsMap;

	UPROPERTY(BlueprintAssignable)
	FOnChangeStaticMeshPaintingSettingsSignature OnChangeMeshPaintingSettings;

	UPROPERTY(BlueprintAssignable)
	FOnChangeStaticMeshPaintCriteriaSignature OnChangeMeshPaintCriteria;

	UPROPERTY(BlueprintAssignable)
	FOnChangeItemStaticMeshPaintCriteriaSignature OnChangeItemMeshPaintCriteria;
