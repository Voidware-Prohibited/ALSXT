...
#include "AlsxtAbilitySystemComponentBase.generated.h"
...
UCLASS()
class ALSXT_API UAlsxtAbilitySystemComponentBase : public UAbilitySystemComponent
{
	GENERATED_BODY()

public:
	// Sets default values for this component's properties
	UAlsxtAbilitySystemComponentBase();
