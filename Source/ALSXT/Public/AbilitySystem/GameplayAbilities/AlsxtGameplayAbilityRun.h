...
#include "AlsxtGameplayAbilityRun.generated.h"
 ...
 */
UCLASS()
class ALSXT_API UAlsxtGameplayAbilityRun : public UAlsxtGameplayAbilityExternalCooldowns
{
	GENERATED_BODY()
	
public:
	UAlsxtGameplayAbilityRun();
