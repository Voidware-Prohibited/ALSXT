...
#include "AlsxtGameplayAbilityWeaponReadyPosition.generated.h"

/**
 * 
 */
UCLASS()
class ALSXT_API UAlsxtGameplayAbilityWeaponReadyPosition : public UAlsxtGameplayAbilityBase
{
	GENERATED_BODY()
public:
	UAlsxtGameplayAbilityWeaponReadyPosition();
...
protected:
	...
	FGameplayTag DefaultWeaponReadyPositionTag;

	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Gameplay Tags")
	FGameplayTagContainer CurrentAllowedWeaponReadyPositions;
