...
{
	UE_DEFINE_GAMEPLAY_TAG(HandsTiedBothHands, TEXT("Als.OverlayMode.BothHands.HandsTied"))
	UE_DEFINE_GAMEPLAY_TAG(RifleLeftHandActive, TEXT("Als.OverlayMode.LeftHand.Active.Rifle"))
	UE_DEFINE_GAMEPLAY_TAG(RifleLeftHandNeutral, TEXT("Als.OverlayMode.LeftHand.Neutral.Rifle"))
	UE_DEFINE_GAMEPLAY_TAG(RifleLeftHandPassive, TEXT("Als.OverlayMode.LeftHand.Passive.Rifle"))
	UE_DEFINE_GAMEPLAY_TAG(RifleRightHandActive, TEXT("Als.OverlayMode.RightHand.Active.Rifle"))
	UE_DEFINE_GAMEPLAY_TAG(RifleRightHandNeutral, TEXT("Als.OverlayMode.RightHand.Neutral.Rifle"))
	UE_DEFINE_GAMEPLAY_TAG(RifleRightHandPassive, TEXT("Als.OverlayMode.RightHand.Passive.Rifle"))
	UE_DEFINE_GAMEPLAY_TAG(RifleBothHands, TEXT("Als.OverlayMode.BothHands.Rifle"))
	UE_DEFINE_GAMEPLAY_TAG(PistolLeftHandActive, TEXT("Als.OverlayMode.LeftHand.Active.Pistol"))
	UE_DEFINE_GAMEPLAY_TAG(PistolLeftHandNeutral, TEXT("Als.OverlayMode.LeftHand.Neutral.Pistol"))
	UE_DEFINE_GAMEPLAY_TAG(PistolLeftHandPassive, TEXT("Als.OverlayMode.LeftHand.Passive.Pistol"))
	UE_DEFINE_GAMEPLAY_TAG(PistolRightHandActive, TEXT("Als.OverlayMode.RightHand.Active.Pistol"))
	UE_DEFINE_GAMEPLAY_TAG(PistolRightHandNeutral, TEXT("Als.OverlayMode.RightHand.Neutral.Pistol"))
	UE_DEFINE_GAMEPLAY_TAG(PistolRightHandPassive, TEXT("Als.OverlayMode.RightHand.Passive.Pistol"))
	UE_DEFINE_GAMEPLAY_TAG(PistolBothHands, TEXT("Als.OverlayMode.BothHands.Pistol"))
	UE_DEFINE_GAMEPLAY_TAG(BowBothHands, TEXT("Als.OverlayMode.BothHands.Bow"))
	UE_DEFINE_GAMEPLAY_TAG(TorchLeftHandActive, TEXT("Als.OverlayMode.LeftHand.Active.Torch"))
	UE_DEFINE_GAMEPLAY_TAG(TorchLeftHandNeutral, TEXT("Als.OverlayMode.LeftHand.Neutral.Torch"))
	UE_DEFINE_GAMEPLAY_TAG(TorchLeftHandPassive, TEXT("Als.OverlayMode.LeftHand.Passive.Torch"))
	UE_DEFINE_GAMEPLAY_TAG(TorchRightHandActive, TEXT("Als.OverlayMode.RightHand.Active.Torch"))
	UE_DEFINE_GAMEPLAY_TAG(TorchRightHandNeutral, TEXT("Als.OverlayMode.RightHand.Neutral.Torch"))
	UE_DEFINE_GAMEPLAY_TAG(TorchRightHandPassive, TEXT("Als.OverlayMode.RightHand.Passive.Torch"))
	UE_DEFINE_GAMEPLAY_TAG(TorchBothHands, TEXT("Als.OverlayMode.BothHands.Torch"))
	UE_DEFINE_GAMEPLAY_TAG(BinocularsLeftHandActive, TEXT("Als.OverlayMode.LeftHand.Active.Binoculars"))
	UE_DEFINE_GAMEPLAY_TAG(BinocularsLeftHandNeutral, TEXT("Als.OverlayMode.LeftHand.Neutral.Binoculars"))
	UE_DEFINE_GAMEPLAY_TAG(BinocularsLeftHandPassive, TEXT("Als.OverlayMode.LeftHand.Passive.Binoculars"))
	UE_DEFINE_GAMEPLAY_TAG(BinocularsRightHandActive, TEXT("Als.OverlayMode.RightHand.Active.Binoculars"))
	UE_DEFINE_GAMEPLAY_TAG(BinocularsRightHandNeutral, TEXT("Als.OverlayMode.RightHand.Neutral.Binoculars"))
	UE_DEFINE_GAMEPLAY_TAG(BinocularsRightHandPassive, TEXT("Als.OverlayMode.RightHand.Passive.Binoculars"))
	UE_DEFINE_GAMEPLAY_TAG(BinocularsBothHands, TEXT("Als.OverlayMode.BothHands.Binoculars"))
	UE_DEFINE_GAMEPLAY_TAG(AxeLeftHandActive, TEXT("Als.OverlayMode.LeftHand.Active.Axe"))
	UE_DEFINE_GAMEPLAY_TAG(AxeLeftHandNeutral, TEXT("Als.OverlayMode.LeftHand.Neutral.Axe"))
	UE_DEFINE_GAMEPLAY_TAG(AxeLeftHandPassive, TEXT("Als.OverlayMode.LeftHand.Passive.Axe"))
	UE_DEFINE_GAMEPLAY_TAG(AxeRightHandActive, TEXT("Als.OverlayMode.RightHand.Active.Axe"))
	UE_DEFINE_GAMEPLAY_TAG(AxeRightHandNeutral, TEXT("Als.OverlayMode.RightHand.Neutral.Axe"))
	UE_DEFINE_GAMEPLAY_TAG(AxeRightHandPassive, TEXT("Als.OverlayMode.RightHand.Passive.Axe"))
	UE_DEFINE_GAMEPLAY_TAG(AxeBothHands, TEXT("Als.OverlayMode.BothHands.Axe"))
	UE_DEFINE_GAMEPLAY_TAG(PickaxeLeftHandActive, TEXT("Als.OverlayMode.LeftHand.Active.Pickaxe"))
	UE_DEFINE_GAMEPLAY_TAG(PickaxeLeftHandNeutral, TEXT("Als.OverlayMode.LeftHand.Neutral.Pickaxe"))
	UE_DEFINE_GAMEPLAY_TAG(PickaxeLeftHandPassive, TEXT("Als.OverlayMode.LeftHand.Passive.Pickaxe"))
	UE_DEFINE_GAMEPLAY_TAG(PickaxeRightHandActive, TEXT("Als.OverlayMode.RightHand.Active.Pickaxe"))
	UE_DEFINE_GAMEPLAY_TAG(PickaxeRightHandNeutral, TEXT("Als.OverlayMode.RightHand.Neutral.Pickaxe"))
	UE_DEFINE_GAMEPLAY_TAG(PickaxeRightHandPassive, TEXT("Als.OverlayMode.RightHand.Passive.Pickaxe"))
	UE_DEFINE_GAMEPLAY_TAG(PickaxeBothHands, TEXT("Als.OverlayMode.BothHands.Pickaxe"))
	UE_DEFINE_GAMEPLAY_TAG(KnifeLeftHandActive, TEXT("Als.OverlayMode.LeftHand.Active.Knife"))
	UE_DEFINE_GAMEPLAY_TAG(KnifeLeftHandNeutral, TEXT("Als.OverlayMode.LeftHand.Neutral.Knife"))
	UE_DEFINE_GAMEPLAY_TAG(KnifeLeftHandPassive, TEXT("Als.OverlayMode.LeftHand.Passive.Knife"))
	UE_DEFINE_GAMEPLAY_TAG(KnifeRightHandActive, TEXT("Als.OverlayMode.RightHand.Active.Knife"))
	UE_DEFINE_GAMEPLAY_TAG(KnifeRightHandNeutral, TEXT("Als.OverlayMode.RightHand.Neutral.Knife"))
	UE_DEFINE_GAMEPLAY_TAG(KnifeRightHandPassive, TEXT("Als.OverlayMode.RightHand.Passive.Knife"))
	UE_DEFINE_GAMEPLAY_TAG(HammerLeftHandActive, TEXT("Als.OverlayMode.LeftHand.Active.Hammer"))
	UE_DEFINE_GAMEPLAY_TAG(HammerLeftHandNeutral, TEXT("Als.OverlayMode.LeftHand.Neutral.Hammer"))
	UE_DEFINE_GAMEPLAY_TAG(HammerLeftHandPassive, TEXT("Als.OverlayMode.LeftHand.Passive.Hammer"))
	UE_DEFINE_GAMEPLAY_TAG(HammerRightHandActive, TEXT("Als.OverlayMode.RightHand.Active.Hammer"))
	UE_DEFINE_GAMEPLAY_TAG(HammerRightHandNeutral, TEXT("Als.OverlayMode.RightHand.Neutral.Hammer"))
	UE_DEFINE_GAMEPLAY_TAG(HammerRightHandPassive, TEXT("Als.OverlayMode.RightHand.Passive.Hammer"))
	UE_DEFINE_GAMEPLAY_TAG(GrenadeLeftHandNeutral, TEXT("Als.OverlayMode.LeftHand.Neutral.Grenade"))
	UE_DEFINE_GAMEPLAY_TAG(GrenadeLeftHandPassive, TEXT("Als.OverlayMode.LeftHand.Passive.Grenade"))
	UE_DEFINE_GAMEPLAY_TAG(GrenadeRightHandNeutral, TEXT("Als.OverlayMode.RightHand.Neutral.Grenade"))
	UE_DEFINE_GAMEPLAY_TAG(GrenadeRightHandPassive, TEXT("Als.OverlayMode.RightHand.Passive.Grenade"))
	UE_DEFINE_GAMEPLAY_TAG(BuildingPlanLeftHandActive, TEXT("Als.OverlayMode.LeftHand.Active.BuildingPlan"))
	UE_DEFINE_GAMEPLAY_TAG(BuildingPlanLeftHandNeutral, TEXT("Als.OverlayMode.LeftHand.Neutral.BuildingPlan"))
	UE_DEFINE_GAMEPLAY_TAG(BuildingPlanLeftHandPassive, TEXT("Als.OverlayMode.LeftHand.Passive.BuildingPlan"))
	UE_DEFINE_GAMEPLAY_TAG(BuildingPlanRightHandActive, TEXT("Als.OverlayMode.RightHand.Active.BuildingPlan"))
	UE_DEFINE_GAMEPLAY_TAG(BuildingPlanRightHandNeutral, TEXT("Als.OverlayMode.RightHand.Neutral.BuildingPlan"))
	UE_DEFINE_GAMEPLAY_TAG(BuildingPlanRightHandPassive, TEXT("Als.OverlayMode.RightHand.Passive.BuildingPlan"))
	UE_DEFINE_GAMEPLAY_TAG(FlashlightLeftHandActive, TEXT("Als.OverlayMode.LeftHand.Active.Flashlight"))
	UE_DEFINE_GAMEPLAY_TAG(FlashlightLeftHandNeutral, TEXT("Als.OverlayMode.LeftHand.Neutral.Flashlight"))
	UE_DEFINE_GAMEPLAY_TAG(FlashlightLeftHandPassive, TEXT("Als.OverlayMode.LeftHand.Passive.Flashlight"))
	UE_DEFINE_GAMEPLAY_TAG(FlashlightRightHandActive, TEXT("Als.OverlayMode.RightHand.Active.Flashlight"))
	UE_DEFINE_GAMEPLAY_TAG(FlashlightRightHandNeutral, TEXT("Als.OverlayMode.RightHand.Neutral.Flashlight"))
	UE_DEFINE_GAMEPLAY_TAG(FlashlightRightHandPassive, TEXT("Als.OverlayMode.RightHand.Passive.Flashlight"))
	UE_DEFINE_GAMEPLAY_TAG(KatanaLeftHandActive, TEXT("Als.OverlayMode.LeftHand.Active.Katana"))
	UE_DEFINE_GAMEPLAY_TAG(KatanaLeftHandNeutral, TEXT("Als.OverlayMode.LeftHand.Neutral.Katana"))
	UE_DEFINE_GAMEPLAY_TAG(KatanaLeftHandPassive, TEXT("Als.OverlayMode.LeftHand.Passive.Katana"))
	UE_DEFINE_GAMEPLAY_TAG(KatanaRightHandActive, TEXT("Als.OverlayMode.RightHand.Active.Katana"))
	UE_DEFINE_GAMEPLAY_TAG(KatanaRightHandNeutral, TEXT("Als.OverlayMode.RightHand.Neutral.Katana"))
	UE_DEFINE_GAMEPLAY_TAG(KatanaRightHandPassive, TEXT("Als.OverlayMode.RightHand.Passive.Katana"))
	UE_DEFINE_GAMEPLAY_TAG(SwordLeftHandActive, TEXT("Als.OverlayMode.LeftHand.Active.Sword"))
	UE_DEFINE_GAMEPLAY_TAG(SwordLeftHandNeutral, TEXT("Als.OverlayMode.LeftHand.Neutral.Sword"))
	UE_DEFINE_GAMEPLAY_TAG(SwordLeftHandPassive, TEXT("Als.OverlayMode.LeftHand.Passive.Sword"))
	UE_DEFINE_GAMEPLAY_TAG(SwordRightHandActive, TEXT("Als.OverlayMode.RightHand.Active.Sword"))
	UE_DEFINE_GAMEPLAY_TAG(SwordRightHandNeutral, TEXT("Als.OverlayMode.RightHand.Neutral.Sword"))
	UE_DEFINE_GAMEPLAY_TAG(SwordRightHandPassive, TEXT("Als.OverlayMode.RightHand.Passive.Sword"))
	UE_DEFINE_GAMEPLAY_TAG(Pistol, TEXT("Als.OverlayMode.Pistol"))
...
namespace ALSXTWeaponReadyPositionTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(Wading, TEXT("Als.Weapon Ready Position.Wading"))
