...
float UUnarmedCombatComponent::GetAngle(FVector Target)
{
...
void UUnarmedCombatComponent::TraceForTargets(bool DisplayDebug, float DebugDuration, TArray<FTargetHitResultEntry>& Targets)
{
...
void UUnarmedCombatComponent::GetClosestTarget()
{
...
void UUnarmedCombatComponent::DisengageAllTargets()
{
...
void UUnarmedCombatComponent::GetTargetLeft()
{
	TArray<FTargetHitResultEntry> OutHits;
	TraceForTargets(true, 6, OutHits);
	FTargetHitResultEntry FoundHit;
...
void UUnarmedCombatComponent::GetTargetRight()
{
	TArray<FTargetHitResultEntry> OutHits;
	TraceForTargets(true, 6, OutHits);
	FTargetHitResultEntry FoundHit;
...
void UUnarmedCombatComponent::RotatePlayerToTarget(FTargetHitResultEntry Target)
{
	if (Target.Valid)
	{
